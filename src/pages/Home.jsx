      ...
      <div className="bg-[#faf9fd] text-[#1a1c1e] w-full">
         ...
         <div className="flex flex-col md:flex-row w-full px-6 md:px-10">
            ...
            <div className="flex-1 flex flex-col justify-center py-12 md:pr-10 z-10 text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <button className="bg-white text-[#1a365d] px-8 py-4 rounded-lg font-semibold text-center hover:bg-white/90 active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                ...
                <Link
                  to="/doctors"
                  className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-4 rounded-lg font-semibold text-center hover:bg-white/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
                  <UserSearch size={20} />
                  Find a Doctor
                </Link>
              ...
              <div className="flex items-center gap-5 mt-12">
                <div className="flex">
                  <img src="45.jpg" className="w-12 h-12 rounded-full border-2 border-white" alt="Patient" />
                  <img src="40.jpg" className="w-12 h-12 rounded-full border-2 border-white -ml-4" alt="Patient" />
                  <img src="60.jpg" className="w-12 h-12 rounded-full border-2 border-white -ml-4" alt="Patient" />
                </div>
                <div>
                  <p className="font-bold text-white">Trusted by Thousands of Patients</p>
                  <p className="text-sm text-white/70">Delivering quality healthcare every day.</p>
                </div>
              </div>
        ...
        <section className="w-full px-6 md:px-10 py-12 md:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="bg-[#f4f3f7] p-6 rounded-xl border border-[#c4c6cf] hover:border-[#1a365d] transition-all cursor-pointer">
              ...
              <p className="font-semibold text-[#1a1c1e] mb-2">Emergency Care</p>
              <p className="text-sm text-[#43474e]">Immediate 24/7 trauma assistance</p>
            </div>
            ...
            <div className="bg-[#f4f3f7] p-6 rounded-xl border border-[#c4c6cf] hover:border-[#1a365d] transition-all cursor-pointer">
              ...
              <p className="text-sm text-[#43474e]">Advanced heart &amp; vascular health</p>
            </div>
            ...
            <div className="bg-[#f4f3f7] p-6 rounded-xl border border-[#c4c6cf] hover:border-[#1a365d] transition-all cursor-pointer">
              ...
              <p className="text-sm text-[#43474e]">Specialized care for children</p>
            </div>
            ...
            <div className="bg-[#f4f3f7] p-6 rounded-xl border border-[#c4c6cf] hover:border-[#1a365d] transition-all cursor-pointer">
              ...
              <p className="text-sm text-[#43474e]">State-of-the-art lab services</p>
            </div>
        ...
        <section className="w-full px-6 md:px-10 py-12 md:py-20">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <Link to="/doctors" className="text-sm font-semibold text-[#1a365d] hover:underline flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {[
              { name: "Dr. Sarah Kim", dept: "Cardiology Specialist", years: "12 Years Experience", image: "sarah.jpg" },
              { name: "Dr. James Carter", dept: "Head of Pediatrics", years: "15 Years Experience", image: "james.jpg" },
              { name: "Dr. Emily Johnson", dept: "Senior Neurologist", years: "8 Years Experience", image: "emily.jpg" },
              { name: "Dr. David Brown", dept: "Orthopedics Consultant", years: "10 Years Experience", image: "david.jpg" },
            ].map((doctor) => (
              <div
                key={doctor.name}
              ...
              >
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-[#1a1c1e] mb-1">{doctor.name}</h4>
          ...
          <div className="w-full px-6 md:px-10 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-2/3">
              <div className="bg-white rounded-2xl p-10 border border-[#c4c6cf] relative shadow-sm">
                <Quote size={56} className="absolute top-6 right-8 text-[#1a365d] opacity-20" />
        ...
        <section className="py-20 bg-[#1a365d]">
          <div className="w-full text-center px-6">
            ...
            <p className="text-white/80 text-lg mt-6 leading-8">
              Book an appointment today and receive exceptional healthcare
              from our experienced specialists in a modern and compassionate
              environment.
            </p>
